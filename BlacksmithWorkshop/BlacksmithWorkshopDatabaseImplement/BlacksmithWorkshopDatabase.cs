...
namespace BlacksmithWorkshopDatabaseImplement
{
	public class BlacksmithWorkshopDatabase : DbContext
	{
		protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
		{
			...
			{
				optionsBuilder.UseSqlServer(@"Data Source=(localdb)\MSSQLLocalDB;initial catalog='BlacksmithWorkshopDatabaseDopMail';Integrated Security=True;MultipleActiveResultSets=True;");
			}
